    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Content */}
          {/* Modal Content - Click wrapper to close */}
          <motion.div
          ...
          >
            <div className="relative w-full max-w-md">
              {/* Glassmorphic Card - Stop propagation to prevent closing */}
              <div
                ...
                <div className="relative p-8">
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      ...
                      {/* Button Content */}
                      {/* Button Content - Grid Stack for stable width */}
                      <div className="relative grid place-items-center">
                        {/* Normal State (Invisible when loading, but keeps width if wider) */}
                        <span
                        ...
                        {/* Loading State (Invisible when not loading, but keeps width if wider) */}
                        <span
                          className={`col-start-1 row-start-1 flex items-center justify-center gap-2 transition-opacity duration-200 ${
                            isLoading
                              ? "opacity-100 visible"
