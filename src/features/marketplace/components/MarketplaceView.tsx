...
import { Wallet, Star, ArrowUpRight, Lock, Filter } from "lucide-react";
...
const highYieldAssets = [
  {
    ...
    roi: "145%",
    image:
      "https://images.unsplash.com/photo-1614064642578-7faacdc6336e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjeWJlcnB1bmslMjBzZWN1cmUlMjBkaWdpdGFsJTIwdmF1bHQlMjBhY2Nlc3N8ZW58MXx8fHwxNzY4NTc4NDY2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    specs: [
  ...
  },
  {
    ...
    roi: "85%",
    image:
      "https://images.unsplash.com/photo-1664526936810-ec0856d31b92?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzZCUyMGFic3RyYWN0JTIwbmV0d29yayUyMGNvbm5lY3Rpdml0eSUyMGJsdWUlMjBub2Rlc3xlbnwxfHx8fDE3Njg1Nzg0NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    specs: [
      ...
      <div className="relative h-[300px] w-full rounded-2xl overflow-hidden mb-8 group border border-white/10">
        ...
        <div className="absolute bottom-0 left-0 p-8 z-20 max-w-2xl">
          ...
          <h1 className="text-4xl font-bold text-white mb-2 leading-tight">
            High-Performance <br />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-200 to-cyan-500">
              Asset Exchange
            </span>
          </h1>
          <p className="text-gray-400 text-sm max-w-md">
            Access enterprise-grade automation scripts, scalability nodes, and
            AI cores. Deploy instantly to your private cloud.
          </p>
        </div>
        ...
        <div className="lg:col-span-3 space-y-12">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {[
              ...
              <button
                key={tag}
                className="px-3 py-2 bg-black/40 border border-dashed border-white/10 hover:border-cyan-500/50 rounded-lg text-gray-500 hover:text-cyan-400 transition-colors text-xs font-mono"
              >
                {tag}
              </button>
            ))}
          ...
          {/* VIP Locked Section */}
          <div className="relative rounded-2xl border border-white/10 bg-linear-to-br from-black to-gray-900 p-8 overflow-hidden group">
            ...
            <div className="relative z-10 flex justify-between items-end opacity-50 group-hover:opacity-20 transition-opacity">
              <div>
                ...
                <p className="text-gray-400 max-w-md">
                  Exclusive access to experimental quantum cores and pre-market
                  automation scripts.
                </p>
              </div>
