...
const testimonials = [
  {
    ...
    content: 'Implementamos el sistema en menos de 10 minutos. No podía creer lo simple que era. El soporte es excepcional.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'La transparencia en los precios y la claridad del proceso me dieron total confianza. Vale cada centavo.',
    rating: 5,
  ...
  },
  {
    ...
    name: 'Roberto Silva',
    role: 'CTO, DataCorp',
    content: 'Finalmente una solución empresarial que no requiere un equipo técnico para configurar. Increíble.',
    rating: 5,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            {/* Content */}
            <p className={`text-sm mb-6 leading-relaxed relative z-10 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
              "{testimonial.content}"
            </p>
