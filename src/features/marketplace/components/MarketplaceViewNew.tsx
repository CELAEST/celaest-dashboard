...
const products = [
  {
    ...
    description: 'Automatiza tus procesos de negocio sin código. Listo para usar en 5 minutos con soporte completo incluido.',
    price: '$4,500',
    image: 'https://images.unsplash.com/photo-1614064642578-7faacdc6336e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjeWJlcnB1bmslMjBzZWN1cmUlMjBkaWdpdGFsJTIwdmF1bHQlMjBhY2Nlc3N8ZW58MXx8fHwxNzY4NTc4NDY2fDA&ixlib=rb-4.1.0&q=80&w=1080',
    features: [
  ...
  },
  {
    ...
    description: 'Red de alta velocidad distribuida globalmente. Sin configuración técnica, activación instantánea.',
    price: '$1,200/mes',
    image: 'https://images.unsplash.com/photo-1664526936810-ec0856d31b92?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzZCUyMGFic3RyYWN0JTIwbmV0d29yayUyMGNvbm5lY3Rpdml0eSUyMGJsdWUlMjBub2Rlc3xlbnwxfHx8fDE3Njg1Nzg0NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    features: [
  ...
  },
  {
    ...
    description: 'Inteligencia de datos avanzada sin complejidad. Dashboards listos, insights automáticos.',
    price: '$8,900',
    image: 'https://images.unsplash.com/photo-1639322537228-f710d846310a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGRhdGElMjB2aXN1YWxpemF0aW9uJTIwZnV0dXJpc3RpYyUyMGhvbG9ncmFtfGVufDF8fHx8MTc2ODU4MTU5OHww&ixlib=rb-4.1.0&q=80&w=1080',
    features: [
  ...
  },
  {
    ...
    description: 'Protección completa sin mantenimiento. Sistema inteligente que se actualiza automáticamente.',
    price: '$2,100',
    image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjeWJlcnNlY3VyaXR5JTIwbG9jayUyMHNlY3VyZSUyMHByb3RlY3Rpb258ZW58MXx8fHwxNzY4NTgxNTk4fDA&ixlib=rb-4.1.0&q=80&w=1080',
    features: [
    ...
    `}>
      ...
      <div className="relative mb-16">
        ...
        <div className="relative h-[400px] w-full overflow-hidden rounded-3xl">
          <div className={`absolute inset-0 z-10 ${theme === 'dark' ? 'bg-gradient-to-r from-black via-black/80 to-transparent' : 'bg-gradient-to-r from-white via-white/90 to-transparent'}`} />
          <ImageWithFallback
          ...
          <div className="absolute bottom-0 left-0 p-12 z-20 max-w-3xl">
            ...
            >
              <h1 className={`text-5xl font-bold mb-4 leading-tight ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
              ...
              <p className={`text-lg mb-6 max-w-xl leading-relaxed ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
        ...
        >
          ...
          `}>
            <Search className={`ml-4 ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`} size={20} />
            <input
              type="text"
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className={`
            ...
            ${theme === 'dark'
              ? 'bg-gradient-to-br from-cyan-900/20 to-black border border-cyan-500/20'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-12">
            <div className="flex flex-col justify-center space-y-6">
              ...
              <p className={`text-lg leading-relaxed ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                En este video de 2 minutos, descubra lo fácil que es activar su nueva solución empresarial. Sin jerga técnica, solo claridad total.
              </p>
            ...
            <div className="relative h-80 rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${theme === 'dark' ? 'bg-cyan-500' : 'bg-white'}`}>
                  <Play size={32} className={theme === 'dark' ? 'text-black' : 'text-gray-900'} fill="currentColor" />
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.div
          ...
          className={`
            ...
            ${theme === 'dark'
              ? 'bg-gradient-to-b from-black to-cyan-950/20'
              : 'bg-gradient-to-b from-gray-50 to-cyan-50/30'
            }
          `}
        >
          ...
          <p className={`text-sm mb-8 max-w-2xl mx-auto ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
            Procesamos cada transacción con el mismo nivel de seguridad que los bancos suizos. Su información jamás se comparte. Garantizado.
          </p>
          <TrustBadges />
        </motion.div>
      </div>
