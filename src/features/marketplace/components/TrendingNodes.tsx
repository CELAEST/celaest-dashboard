...
export const TrendingNodes: React.FC = () => {
    return (
        <div className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-6">Trending Scalability Nodes</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-[500px]">
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 p-6 w-full">
                        <div className="flex items-center gap-2 mb-2">
                             ...
                             <span className="text-xs font-mono text-cyan-400 uppercase">Global Infrastructure</span>
                        </div>
                        <h3 className="text-2xl font-bold text-white mb-2">Omni-Channel Logistics API</h3>
                        <p className="text-gray-300 text-sm mb-4 line-clamp-2">Connect to 500+ carriers worldwide with a single integration point. Real-time tracking and customs automation.</p>
                ...
                <div className="md:col-span-1 md:row-span-1 bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 relative group hover:border-cyan-500/30 transition-colors">
                    ...
                    <p className="text-xs text-gray-400">Edge compute nodes for ultra-low latency apps.</p>
                </div>
                ...
                <div className="md:col-span-1 md:row-span-1 bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 relative group hover:border-cyan-500/30 transition-colors">
                    ...
                    <p className="text-xs text-gray-400">Infinite storage with AI indexing built-in.</p>
                </div>
                ...
                <div className="md:col-span-2 md:row-span-1 bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 relative group hover:border-cyan-500/30 transition-colors flex items-center justify-between">
                     <div>
                        <div className="flex items-center gap-2 mb-2">
                             ...
                             <span className="text-xs font-mono text-yellow-400 uppercase">Security First</span>
                        </div>
                        <h3 className="text-xl font-bold text-white">Enterprise Firewall</h3>
                        <p className="text-xs text-gray-400 mt-1">DDoS protection up to 50Tbps.</p>
                     </div>
                     <div className="h-16 w-32 bg-white/5 rounded-lg flex items-center justify-center">
                         <span className="font-mono text-2xl font-bold text-white">$499</span>
                     </div>
                </div>
            </div>
        </div>
