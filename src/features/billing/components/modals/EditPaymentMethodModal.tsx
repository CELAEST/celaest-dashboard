      ...
      >
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
          <div className="p-6 md:w-1/2 flex flex-col justify-center">
            <motion.div
              className={`relative rounded-2xl p-6 mb-6 aspect-[1.586] overflow-hidden ${
                darkMode
            ...
            >
              ...
              <div>
                ...
                >
                  <Sparkles className="w-3 h-3" /> Secure Configuration
                </div>
                <div
                ...
                >
                  Full card numbers are never stored on our servers. All updates
                  are processed via secure encrypted tokens.
                </div>
              </div>
            </div>
          </div>
