    ...
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className={`rounded-2xl border overflow-hidden ${
          isDark
            ? 'bg-gradient-to-r from-purple-500/10 via-cyan-500/10 to-purple-500/10 border-purple-500/20'
            : 'bg-gradient-to-r from-purple-50 via-cyan-50 to-purple-50 border-purple-200'
        }`}
      >
        <div className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Sparkles size={24} className={isDark ? 'text-purple-400' : 'text-purple-600'} />
              <div>
          ...
          <div className="p-8">
            <div className="flex items-start justify-between mb-6">
              <div className={`p-4 rounded-2xl ${
                ...
                <DollarSign size={32} className={isDark ? 'text-cyan-400' : 'text-cyan-600'} />
              </div>
              ...
              <motion.div
                ...
                className={`text-6xl font-black tracking-tight mb-2 ${
                  isDark
                    ...
                    : 'text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-cyan-400'
                }`}
                style={{
                  textShadow: isDark ? '0 0 40px rgba(34, 211, 238, 0.4)' : 'none',
                }}
              >
        ...
        >
          <div className="flex items-start justify-between mb-6">
            <div className={`p-3 rounded-xl ${
              ...
              <TrendingUp size={24} className={isDark ? 'text-emerald-400' : 'text-emerald-600'} />
            </div>
          </div>
          <div>
        ...
        >
          <div className="flex items-start justify-between mb-6">
            <div className={`p-3 rounded-xl ${
              ...
              <TrendingDown size={24} className={isDark ? 'text-yellow-400' : 'text-yellow-600'} />
            </div>
          </div>
          <div>
            <p className={`text-xs font-semibold mb-2 uppercase tracking-wide ${
        ...
        >
          <div className="flex items-start justify-between mb-6">
            <div className={`p-3 rounded-xl ${
              ...
              <Zap size={24} className={isDark ? 'text-purple-400' : 'text-purple-600'} />
            </div>
          </div>
          <div>
            <p className={`text-xs font-semibold mb-2 uppercase tracking-wide ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <h3 className={`text-lg font-bold mb-4 flex items-center gap-2 ${
            ...
            <CreditCard size={20} className={isDark ? 'text-cyan-400' : 'text-cyan-600'} />
          ...
          <div className="space-y-3">
            ...
            <div className={`p-4 rounded-xl border ${
              ...
              <button className={`text-xs font-semibold ${
                isDark ? 'text-orange-400 hover:text-orange-300' : 'text-orange-700 hover:text-orange-800'
              }`}>
                Review Queue →
              </button>
            </div>
            ...
            <div className={`p-4 rounded-xl border ${
              ...
              <button className={`text-xs font-semibold ${
                isDark ? 'text-red-400 hover:text-red-300' : 'text-red-700 hover:text-red-800'
              }`}>
                Contact Customers →
              </button>
            </div>
        ...
        >
          <h3 className={`text-lg font-bold mb-4 flex items-center gap-2 ${
            ...
            <Globe size={20} className={isDark ? 'text-cyan-400' : 'text-cyan-600'} />
          ...
          <button className={`w-full mt-4 py-3 rounded-xl font-semibold text-sm transition-all ${
            isDark
              ? 'bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 border border-cyan-500/20'
              : 'bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200'
          }`}>
