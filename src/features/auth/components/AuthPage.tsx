...
import { Lock, Mail, User, Shield, AlertCircle, CheckCircle2, Eye, EyeOff, ArrowRight, Moon, Sun } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <motion.img
            src={
              isDark
                ? (mode === 'signin' ? '/images/auth/loguin30.jpg' : '/images/auth/loguin40.jpg')
                : (mode === 'signin' ? '/images/auth/loguin3.jpg' : '/images/auth/loguin4.jpg')
            }
            alt="Background"
          ...
          <div className="w-full">
            ...
            >
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className={`text-xs tracking-widest mt-1 ${isDark ? 'text-cyan-400/60' : 'text-blue-500/60'}`}>
                  DASHBOARD
                </span>
              </div>
            </motion.div>
            ...
            <AnimatePresence mode="wait">
              {error && (
                <motion.div
                  ...
                  className="mb-4"
                >
                  <Alert className={`border ${isDark ? 'border-red-500/30 bg-red-500/10' : 'border-red-300 bg-red-50'}`}>
              ...
              {success && (
                <motion.div
                  ...
                  className="mb-4"
                >
                  <Alert className={`border ${isDark ? 'border-green-500/30 bg-green-500/10' : 'border-green-300 bg-green-50'}`}>
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="relative mt-1.5">
                      ...
                      <Input
                        ...
                        className={`pl-11 h-12 ${isDark ? 'bg-white/5 border-white/10 text-white focus:border-cyan-500' : 'bg-gray-50 border-gray-300 focus:border-blue-500'}`}
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input
                      ...
                      className={`pl-11 pr-11 h-12 ${isDark ? 'bg-white/5 border-white/10 text-white focus:border-cyan-500' : 'bg-gray-50 border-gray-300 focus:border-blue-500'}`}
                      placeholder="••••••••"
                      required
                      minLength={6}
                    />
                ...
                <Button
                  ...
                  className={`w-full h-12 text-base font-medium ${
                    isDark 
                      ? 'bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white shadow-[0_0_30px_rgba(34,211,238,0.3)]' 
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className={`px-2 ${isDark ? 'bg-black/40 text-gray-400' : 'bg-white/90 text-gray-500'}`}>
                      Or continue with
                    </span>
                  </div>
                </div>
            ...
            <div className="mt-8">
              <div className="flex items-center justify-center gap-6 text-xs">
                <div className="flex items-center gap-1.5">
                  <Lock className={`w-4 h-4 ${isDark ? 'text-cyan-400' : 'text-blue-600'}`} />
                  <span className={isDark ? 'text-gray-500' : 'text-gray-600'}>256-bit Encryption</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Shield className={`w-4 h-4 ${isDark ? 'text-cyan-400' : 'text-blue-600'}`} />
                  <span className={isDark ? 'text-gray-500' : 'text-gray-600'}>Secure</span>
                </div>
              </div>
            </div>
          </div>
