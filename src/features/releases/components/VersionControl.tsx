            ...
            <tbody className={`divide-y ${
              ...
              {versions.map((version, index) => (
                ...
                >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-mono px-2 py-0.5 rounded ${
                          isDark ? 'bg-white/10 text-cyan-400' : 'bg-gray-100 text-gray-700'
                        }`}>
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border uppercase ${
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <Calendar size={14} className={isDark ? 'text-gray-600' : 'text-gray-400'} />
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <Shield size={14} className={isDark ? 'text-emerald-500' : 'text-emerald-600'} />
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <Download size={14} className={isDark ? 'text-gray-600' : 'text-gray-400'} />
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="relative inline-block">
                      <button
                        onClick={() => setActiveMenu(activeMenu === version.id ? null : version.id)}
