...
export const AnalyticsConsole: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col min-h-0 overflow-hidden bg-transparent">
      {/* Header - Fixed */}
      <PageBanner
        title={isSuperAdmin ? t("operations_telemetry") : t("my_analytics")}
        subtitle={isSuperAdmin ? t("command_deck") : t("panel_live")}
        actions={
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {t("network_label")}: <span className="text-emerald-500">{t("network_status_optimal")}</span>
            </div>
          </div>
        }
      />
