  ...
  if (active && payload && payload.length) {
    return (
      <div className={`px-3 py-2 rounded-lg border ${
        ...
        <p className="text-sm font-medium">{payload[0].value} {payload[0].dataKey === 'hours' ? 'horas' : 'tareas'}</p>
      </div>
    );
  }
  return null;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          subtitle={isAdmin ? "De 1,200 licencias vendidas" : "Promedio de ejecuciones diarias"}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className={`font-semibold flex items-center gap-2 ${
              ...
              <Clock size={18} className={isDark ? 'text-cyan-400' : 'text-blue-600'} />
            ...
            <AreaChart data={timeSavedData}>
              <defs>
                <linearGradient id="colorHours" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor={isDark ? '#22d3ee' : '#3b82f6'} stopOpacity={0.3}/>
                  <stop offset="95%" stopColor={isDark ? '#22d3ee' : '#3b82f6'} stopOpacity={0}/>
                </linearGradient>
              </defs>
        ...
        >
          <h3 className={`font-semibold mb-6 flex items-center gap-2 ${
            ...
            <CheckCircle2 size={18} className={isDark ? 'text-cyan-400' : 'text-blue-600'} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <h3 className={`font-semibold mb-6 flex items-center gap-2 ${
              ...
              <BarChart3 size={18} className={isDark ? 'text-cyan-400' : 'text-blue-600'} />
                  ...
                  <div className={`h-2 rounded-full overflow-hidden ${
                    ...
                    <motion.div
                      ...
                      style={{ 
                        ...
                        boxShadow: isDark ? `0 0 10px ${template.color}` : 'none'
                      }}
                    />
                  </div>
                </div>
          ...
          >
            ...
            <button className={`w-full mt-4 px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2 border ${
              isDark 
      ...
      {!isAdmin && (
        <motion.div
          ...
          className={`backdrop-blur-xl border rounded-2xl p-8 text-center relative overflow-hidden ${
            isDark ? 'bg-[#0a0a0a]/60 border-cyan-500/30' : 'bg-white border-blue-200 shadow-sm'
          }`}
        >
          ...
          <div className="relative z-10">
            <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
              ...
              <Target size={32} className={isDark ? 'text-cyan-400' : 'text-blue-600'} />
            </div>
            ...
            <p className={`text-lg mb-4 ${
              ...
              Este mes, tus plantillas te ahorraron <span className={`font-bold ${
                isDark ? 'text-cyan-400' : 'text-blue-600'
              }`}>108 horas</span> de trabajo manual
            </p>
            <p className={`text-sm ${
              isDark ? 'text-gray-500' : 'text-gray-500'
            }`}>
              Eso equivale a <strong>$12,450</strong> en valor generado basado en costo/hora promedio
            </p>
          </div>
        </motion.div>
      )}
