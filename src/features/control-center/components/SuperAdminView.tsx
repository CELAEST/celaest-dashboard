...
import { Building2, Users, Database, ShieldAlert, Key } from "lucide-react";
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div>
        ...
        <p className="text-sm tracking-widest uppercase font-bold text-gray-500 mt-2">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {organizations?.organizations?.length === 0 && (
              <div className="col-span-full p-12 text-center border-2 border-dashed border-black/10 dark:border-white/10 rounded-2xl">
                <Building2 className="w-12 h-12 mx-auto mb-4 text-gray-400 opacity-20" />
