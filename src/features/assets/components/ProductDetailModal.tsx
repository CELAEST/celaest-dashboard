          ...
          <div className="p-8">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  <Download size={16} className={isDark ? 'text-gray-500' : 'text-gray-400'} />
                  <span className={`text-sm ${
                    isDark ? 'text-gray-400' : 'text-gray-600'
                  }`}>
                  ...
                  {product.features.map((feature, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className={`mt-0.5 p-1 rounded ${
                        ...
                        <Check size={14} className={isDark ? 'text-cyan-400' : 'text-blue-600'} />
                      </div>
                      <span className={`text-sm ${
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${
                      ...
                      Download access and private documentation will be available after payment confirmation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-4">
              {product.isPurchased ? (
                <>
                  <button className={`flex-1 py-4 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${
                    isDark
                  ...
                  <button className={`px-6 py-4 rounded-xl font-bold text-sm transition-all ${
                    isDark
