  ...
  const products: Product[] = [
    {
      ...
      downloads: 342,
      description:
        "Comprehensive financial analysis tool with automated reporting, P&L statements, and cash flow forecasting.",
      features: [
    ...
    },
    {
      ...
      downloads: 567,
      description:
        "Powerful web scraping tool with anti-bot detection, proxy support, and automatic data cleaning.",
      features: [
    ...
    },
    {
      ...
      downloads: 891,
      description:
        "Complete inventory tracking system with real-time stock alerts, supplier management, and purchase order automation.",
      features: [
    ...
    },
    {
      ...
      downloads: 189,
      description:
        "Professional CRM analytics suite with customer segmentation, sales pipeline tracking, and performance metrics.",
      features: [
